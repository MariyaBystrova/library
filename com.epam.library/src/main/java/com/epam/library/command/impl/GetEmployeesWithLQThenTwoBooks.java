...
public class GetEmployeesWithLQThenTwoBooks implements Command {
	private final static Logger logger = LogManager.getLogger(GetEmployeesWithLQThenTwoBooks.class.getName());
	...
	public Response execute(Request request) {
		...
		try {
			Map<Employee, Integer> map = employeeService.getEmployeesWithLQThanTwoBooks();
